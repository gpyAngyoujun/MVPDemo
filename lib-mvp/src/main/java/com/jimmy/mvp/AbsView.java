...
import com.jimmy.mvp.proxy.AbsCacheProxy;
import com.jimmy.mvp.proxy.MVPProxyHelper;
...
public abstract class AbsView<P extends IPresenter, VH extends AbsView.AbsViewHolder> extends Fragment
    ...
    public final View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mHolder == null) {
            View rootView = inflater.inflate(onBindingLayoutRes(), container, false);
    ...
    protected void onFirstShow() {
        mPresenter.enablePresenter(true);
     ...
     */
    protected abstract int onBindingLayoutRes();
     ...
     * 在此处初始化view的listener
     */
    protected abstract void onBindingListener();
